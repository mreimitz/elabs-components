...
| --------------------------------------------------- | ----------------------------------------------------------------------------------- |
| Rendering messages / surfaces / components          | **brand-ui packages** (`@elabs/components-*`) — yes                                 |
...
| The `ai` SDK runtime (`useChat`, `@ai-sdk/*`)       | the app — `@elabs/components-ai` imports the SDK **types only** (D6)                |
...
out of `@elabs/components-*` is what lets many apps and many agents drive the same components. The
