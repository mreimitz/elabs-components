...
**By the numbers:** 429 components across 13 packages — tokens 2 · icons 32 · ui 131 · data 6 · ai 75 · flow 19 · maps 8 · charts 94 · marketing 7 · editor 7 · viewer 5 · terminal 17 · process 26. A component counts once per component module; its sub-parts (`CardHeader`) and exported constants are not counted separately. The theme token contract (`THEME_TOKEN_NAMES`) has 211 tokens, and 41 architecture decision records explain the _why_.
