...
**By the numbers:** 460 components across 13 packages — tokens 2 · icons 32 · ui 133 · data 14 · ai 75 · flow 19 · maps 18 · charts 104 · marketing 8 · editor 7 · viewer 5 · terminal 17 · process 26. A component counts once per component module; its sub-parts (`CardHeader`) and exported constants are not counted separately. The theme token contract (`THEME_TOKEN_NAMES`) has 241 tokens, and 42 architecture decision records explain the _why_.
