 ...
 * the status WORD, and the `Timeline` node styling varies fill, border-style and
 * ring per state — so a greyscale render (or a screen reader) recovers the same
 * information as a colour one.
 */
"use client";
...
export const DEMO_ACTIVITY: TimelineEntry[] = [
  {
