    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="min-w-0 flex-1 overflow-auto p-3">
          {/* With both side panels open the sheet keeps ~600 px at 1440 px wide — still a fine
           * editing surface, so the one-column "phone" fallback only kicks in below 480 px. */}
