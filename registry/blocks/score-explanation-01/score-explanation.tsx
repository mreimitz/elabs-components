...
import { leadScore, type ScoreSignal } from "@/components/agent-ops-parts/data/atlas-ops";
import { formatCount, formatSignedPoints } from "@/components/agent-ops-parts/format";
