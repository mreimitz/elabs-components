...
The in-loop sibling of the durable CI gate (`@elabs-ai/components-eslint-config` →
...
`@elabs-ai/components-eslint-config/rules/brand-tokens.js` · `scripts/check-raw-palette.mjs`)
