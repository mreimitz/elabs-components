...
| ---------------------------------------------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------ |
| A **conversation** (text, tool calls, reasoning, sources, files) | **AI SDK `UIMessage`** + `@qlik-coe-emea/qlabs-components-ai` chat components | **Shipped.** The default.                              |
...
| **Ad-hoc agent JSX** (flexible, less safe)                       | **`JSXPreview`** (`@qlik-coe-emea/qlabs-components-ai`)                       | **Shipped.** Escape hatch — prefer A2UI when it lands. |
...
- **`ai` (Vercel AI SDK): types-only, peer, never runtime.** `@qlik-coe-emea/qlabs-components-ai` may `import type`
