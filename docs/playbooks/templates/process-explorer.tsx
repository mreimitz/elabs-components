/* GENERATED from packages/process/src/templates-process-explorer.stories.tsx by pnpm gen — do not edit. */
/* Full-screen process-explorer template (single source of truth: the Storybook story). */
...
import { AbstractionControls } from "@elabs-ai/components-process";
import { activityColorScale } from "@elabs-ai/components-process";
import { CaseTable, casesFromLog } from "@elabs-ai/components-process";
import { CaseTimeline } from "@elabs-ai/components-process";
import { MetricLayerSwitch } from "@elabs-ai/components-process";
import { ProcessFilterBar } from "@elabs-ai/components-process";
import { ProcessKpiStrip } from "@elabs-ai/components-process";
import { ProcessMap, formatDurationMs, processEdgeId } from "@elabs-ai/components-process";
import { useProcessExplorer } from "@elabs-ai/components-process";
import { VariantExplorer } from "@elabs-ai/components-process";
