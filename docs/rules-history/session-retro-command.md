# session-retro command — history (moved on 2026-09-06)

Moved out of `.claude/commands/session-retro.md` on 2026-09-06 when the command was cut to at most three ranked findings and a delete-or-tighten-first fix policy. The live file keeps its frontmatter (description, argument-hint, allowed-tools) and is not reproduced here; the body below is the previous prose, verbatim.

## Original command body (verbatim, 2026-09-06)
