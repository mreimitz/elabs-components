...
/**
 * Contract probe for AppIcon (`packages/icons/src/app-icon.tsx`), derived from its
 * `Default` story (packages/icons/src/app-icon.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../app-icon.stories";
...
describe("AppIcon contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="app-icon" on its root', () => {
