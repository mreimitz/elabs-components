...
/**
 * Contract probe for BrandLogo (`packages/icons/src/brand-logo.tsx`), derived from its
 * `Default` story (packages/icons/src/brand-logo.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../brand-logo.stories";
...
describe("BrandLogo contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="brand-logo" on its root', () => {
    const { container } = render(<Component {...args} />);
    expect(container.querySelector('[data-slot="brand-logo"]')).not.toBeNull();
  });
});
