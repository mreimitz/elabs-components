...
/**
 * Contract probe for CaseTable (`packages/process/src/case-table/case-table.tsx`), derived from its
 * `Default` story (packages/process/src/case-table/case-table.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../case-table/case-table.stories";
...
describe("CaseTable contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="case-table" on its root', () => {
    const { container } = render(<Component {...args} />);
    expect(container.querySelector('[data-slot="case-table"]')).not.toBeNull();
  });
});
