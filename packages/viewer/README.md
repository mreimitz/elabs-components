...
```json
"@elabs/components-viewer": "workspace:*"
```
...
@source "../node_modules/@elabs/components-viewer/dist";
```
...
One union from `@elabs/components-ui` covers every way an app can
...
```tsx
import { createRegistry, FileViewer } from "@elabs/components-viewer";
