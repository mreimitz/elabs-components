...
/**
 * Contract probe for DataGrid (`packages/data/src/data-grid/data-grid.tsx`), derived from its
 * `Default` story (packages/data/src/data-grid/data-grid.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../data-grid/data-grid.stories";
...
describe("DataGrid contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="data-grid" on its root', () => {
