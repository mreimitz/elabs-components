 ...
 *
 * Since #188 the numbers are DERIVED, not re-hardcoded: @qlik-coe-emea/qlabs-components-ui owns the canonical
...
/**
 * Canonical heading font-size per level, in rem — derived from the @qlik-coe-emea/qlabs-components-ui
...
/** Canonical heading weight (Tailwind `font-semibold`) — derived from @qlik-coe-emea/qlabs-components-ui. */
export const MARKDOWN_HEADING_WEIGHT = PROSE_HEADING_WEIGHT;

/** Canonical heading letter-spacing (Tailwind `tracking-tight`) — derived from @qlik-coe-emea/qlabs-components-ui. */
