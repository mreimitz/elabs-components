/**
 * MetricBlock — thin alias for the canonical `@elabs/components-ui` MetricCard.
 *
 * Previously a fork that added `description` + avoided an editor→charts sideways
 * dep. Now that MetricCard lives in `@elabs/components-ui` (which @elabs/components-editor already depends
 ...
 */
import { MetricCard, type MetricCardProps } from "@elabs/components-ui";
