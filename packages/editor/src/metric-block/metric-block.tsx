/**
 * MetricBlock — thin alias for the canonical `@qlik-coe-emea/qlabs-components-ui` MetricCard.
 *
 * Previously a fork that added `description` + avoided an editor→charts sideways
 * dep. Now that MetricCard lives in `@qlik-coe-emea/qlabs-components-ui` (which @qlik-coe-emea/qlabs-components-editor already depends
 ...
 */
import { MetricCard, type MetricCardProps } from "@qlik-coe-emea/qlabs-components-ui";
