...
/**
 * Contract probe for ChatShell (`packages/ai/src/chat-shell.tsx`), derived from its
 * `Default` story (packages/ai/src/chat-shell.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../chat-shell.stories";
...
describe("ChatShell contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="chat-shell" on its root', () => {
    const { container } = render(<Component {...args} />);
    expect(container.querySelector('[data-slot="chat-shell"]')).not.toBeNull();
  });
});
