...
/**
 * Contract probe for MessageForm (`packages/ai/src/message-form.tsx`), derived from its
 * `Default` story (packages/ai/src/message-form.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../message-form.stories";
...
describe("MessageForm contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="message-form" on its root', () => {
    const { container } = render(<Component {...args} />);
    expect(container.querySelector('[data-slot="message-form"]')).not.toBeNull();
  });
});
