 ...
 * must keep the whole edge. `@qlik-coe-emea/qlabs-components-ai` imported that plugin from three modules
...
/**
 * The shared lazy Mermaid plugin — the `@qlik-coe-emea/qlabs-components-ai` replacement for
