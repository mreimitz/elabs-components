 ...
 * blockquote into the composer. Positioned with the `@qlik-coe-emea/qlabs-components-ui` Popover
...
import { Button, Popover, PopoverAnchor, PopoverContent } from "@qlik-coe-emea/qlabs-components-ui";
