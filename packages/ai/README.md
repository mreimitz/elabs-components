...
```bash
pnpm add @qlik-coe-emea/qlabs-components-ai
```
...
@source "../node_modules/@qlik-coe-emea/qlabs-components-ai/dist";
```
...
calls** (`useChat`, transport, providers) — `@qlik-coe-emea/qlabs-components-ai` imports the `ai` SDK as
