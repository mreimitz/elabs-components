 ...
 *       <Gantt.RowList>     — left task-hierarchy pane (uses @qlik-coe-emea/qlabs-components-ui Tree)
 ...
 *   - Tree: @qlik-coe-emea/qlabs-components-ui Tree component for the left pane (keyboard nav, roving tabindex, a11y)
 ...
 * that risks colliding in a consumer's `import { … } from "@qlik-coe-emea/qlabs-components-charts"`; it is
 ...
 * Read-only cells. Echoes `@qlik-coe-emea/qlabs-components-data` column ergonomics WITHOUT importing it
 * (charts → ui only).
 */
 ...
 * Intentionally echoes `@qlik-coe-emea/qlabs-components-data` sort ergonomics with a friendlier shape
...
/**
 * Build a TreeNode[] hierarchy from flat ResolvedTask[] for the @qlik-coe-emea/qlabs-components-ui Tree.
...
// ── Gantt.RowList (left pane — uses @qlik-coe-emea/qlabs-components-ui Tree) ───────────────────────────
