 ...
 * Gantt smoke tests.
 *
 * Uses the real @qlik-coe-emea/qlabs-components-ui Tree component (it works in jsdom — no layout
 * measurement needed for the non-virtualized path). We only mock:
 *   - motion/react  → no-op so jsdom doesn't choke on animations
 *   - @qlik-coe-emea/qlabs-components-ui Tooltip primitives → passthrough (no Radix portal/ResizeObserver)
...
// Mock @qlik-coe-emea/qlabs-components-ui — pass through all except portal/browser components.
