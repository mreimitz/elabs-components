...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "A re-export of the canonical MetricCard owned by @elabs-ai/components-ui (see Core/MetricCard, ADR 0012). " +
          "It is the *same* component — import from @elabs-ai/components-charts when you are already in a charts " +
          "context, or from @elabs-ai/components-ui otherwise. Don't fork a second KPI tile.",
      },
    },
  },
...
/**
 * The `visual` slot takes any node — here a real token-driven `@elabs-ai/components-charts`
