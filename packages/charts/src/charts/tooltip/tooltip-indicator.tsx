...
export interface ChartTooltipIndicatorProps {
...
export function ChartTooltipIndicator(props: ChartTooltipIndicatorProps) {
  if (!props.visible) {
    return null;
  }
  return <ChartTooltipIndicatorInner {...props} />;
}
...
export default ChartTooltipIndicator;
