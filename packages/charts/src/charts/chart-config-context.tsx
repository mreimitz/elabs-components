...
import { DEFAULT_CHART_INTERACTIONS, type ChartInteractions } from "./chart-interactions";
...
// `ChartInteractions` / `DEFAULT_CHART_INTERACTIONS` moved to
// `./chart-interactions` (RM-173) — a pure leaf, so a chart prop group can
// reference them without pulling React into the definition layer.
// Re-exported here so every existing import keeps working.
export { DEFAULT_CHART_INTERACTIONS, type ChartInteractions } from "./chart-interactions";
