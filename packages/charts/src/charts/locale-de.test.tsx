 ...
 * month names and the translated words — the proof that the module-level
 * host-locale formatters are gone from these paths and that the moved strings
 * read the ui catalogue. A second block proves the per-chart `messages` seam:
 * one chart's override changes that chart only, never a sibling.
 *
