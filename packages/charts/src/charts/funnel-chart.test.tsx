 ...
 * which is exercised by `pnpm --filter @qlik-coe-emea/qlabs-components-docs test-storybook` in CI.
 *
 ...
 * precedent used for @qlik-coe-emea/qlabs-components-editor (Monaco) and @qlik-coe-emea/qlabs-components-flow (React Flow).
 */
