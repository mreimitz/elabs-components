      ...
      {metrics.map((metric, i) => {
        ...
        return (
          <motion.g
            ...
            initial={animate ? { opacity: 0, x: 0, y: 0 } : { opacity: 1, x, y }}
          ...
          >
            <text
              className={
                interactive
                  ? "cursor-pointer transition-opacity duration-fast ease-standard motion-reduce:transition-none hover:opacity-100"
                  : ""
              }
