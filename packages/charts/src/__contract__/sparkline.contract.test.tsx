...
/**
 * Contract probe for Sparkline (`packages/charts/src/sparkline/sparkline.tsx`), derived from its
 * `Default` story (packages/charts/src/sparkline/sparkline.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../sparkline/sparkline.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `charts-sparkline--default|jsdom|jsdom|${assertion}`;
...
describe("Sparkline contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="sparkline" on its root', () => {
