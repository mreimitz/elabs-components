/**
 * doubles.tsx — the jsdom-safe chart components behind `@qlik-coe-emea/qlabs-components-charts/test`
 * (issue #364).
 *
 ...
 * were mocking the whole `@qlik-coe-emea/qlabs-components-charts` barrel as a no-op — which hid real
 ...
 * (`pnpm --filter @qlik-coe-emea/qlabs-components-docs test-storybook`) is for.
 *
...
// `react`, `lucide-react` and `@qlik-coe-emea/qlabs-components-ui` — zero `@visx`/`d3`/`motion`). Re-exporting
