...
```bash
pnpm add @qlik-coe-emea/qlabs-components-charts
```
...
@source "../node_modules/@qlik-coe-emea/qlabs-components-charts/dist";
```
...
130 exported components — including `Area`, `AreaChart`, `AreaChartLoading`, `AutoChart`, `Bar`.
