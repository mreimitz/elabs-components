...
// mirroring the setup in @qlik-coe-emea/qlabs-components-data / -ai.
...
// THIS package's setup would only make @qlik-coe-emea/qlabs-components-ui's own
// tests pass while every other jsdom consumer of a `@qlik-coe-emea/qlabs-components-ui`
