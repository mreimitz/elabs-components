...
/**
 * Contract probe for Meter (`packages/ui/src/components/meter/meter.tsx`), derived from its
 * `Default` story (packages/ui/src/components/meter/meter.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/meter/meter.stories";
...
describe("Meter contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="meter" on its root', () => {
