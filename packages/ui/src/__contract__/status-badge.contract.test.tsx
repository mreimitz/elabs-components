...
/**
 * Contract probe for StatusBadge (`packages/ui/src/components/status-badge/status-badge.tsx`), derived from its
 * `Default` story (packages/ui/src/components/status-badge/status-badge.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/status-badge/status-badge.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `core-statusbadge--default|jsdom|jsdom|${assertion}`;
...
describe("StatusBadge contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="status-badge" on its root', () => {
