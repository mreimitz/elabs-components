...
/**
 * Contract probe for TagInput (`packages/ui/src/components/tag-input/tag-input.tsx`), derived from its
 * `Default` story (packages/ui/src/components/tag-input/tag-input.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/tag-input/tag-input.stories";
...
describe("TagInput contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="tag-input" on its root', () => {
