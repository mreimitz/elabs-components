...
/**
 * Contract probe for DatePicker (`packages/ui/src/components/date-picker/date-picker.tsx`), derived from its
 * `Default` story (packages/ui/src/components/date-picker/date-picker.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/date-picker/date-picker.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `forms-datepicker--default|jsdom|jsdom|${assertion}`;
...
describe("DatePicker contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="date-picker" on its root', () => {
