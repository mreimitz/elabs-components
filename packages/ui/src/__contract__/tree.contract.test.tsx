...
/**
 * Contract probe for Tree (`packages/ui/src/components/tree/tree.tsx`), derived from its
 * `Default` story (packages/ui/src/components/tree/tree.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/tree/tree.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `navigation-tree--default|jsdom|jsdom|${assertion}`;
...
describe("Tree contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="tree" on its root', () => {
