...
/**
 * Contract probe for Timeline (`packages/ui/src/components/timeline/timeline.tsx`), derived from its
 * `Default` story (packages/ui/src/components/timeline/timeline.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/timeline/timeline.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `core-timeline--default|jsdom|jsdom|${assertion}`;
...
describe("Timeline contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="timeline" on its root', () => {
