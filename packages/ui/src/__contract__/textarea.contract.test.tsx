...
/**
 * Contract probe for Textarea (`packages/ui/src/components/textarea/textarea.tsx`), derived from its
 * `Default` story (packages/ui/src/components/textarea/textarea.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/textarea/textarea.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `core-textarea--default|jsdom|jsdom|${assertion}`;
...
describe("Textarea contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="textarea" on its root', () => {
