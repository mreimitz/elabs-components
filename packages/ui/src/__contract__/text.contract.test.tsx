...
/**
 * Contract probe for Text (`packages/ui/src/components/typography/typography.tsx`), derived from its
 * `Default` story (packages/ui/src/components/typography/typography.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/typography/typography.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `foundations-typography--default|jsdom|jsdom|${assertion}`;
...
describe("Text contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="text" on its root', () => {
