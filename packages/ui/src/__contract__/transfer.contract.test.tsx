...
/**
 * Contract probe for Transfer (`packages/ui/src/components/transfer/transfer.tsx`), derived from its
 * `Default` story (packages/ui/src/components/transfer/transfer.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/transfer/transfer.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `forms-transfer--default|jsdom|jsdom|${assertion}`;
...
describe("Transfer contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="transfer" on its root', () => {
