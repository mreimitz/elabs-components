...
/**
 * Contract probe for Toggle (`packages/ui/src/components/toggle/toggle.tsx`), derived from its
 * `Default` story (packages/ui/src/components/toggle/toggle.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/toggle/toggle.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `forms-toggle--default|jsdom|jsdom|${assertion}`;
...
describe("Toggle contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="toggle" on its root', () => {
