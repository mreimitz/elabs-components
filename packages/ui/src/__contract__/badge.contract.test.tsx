...
/**
 * Contract probe for Badge (`packages/ui/src/components/badge/badge.tsx`), derived from its
 * `Default` story (packages/ui/src/components/badge/badge.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/badge/badge.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `core-badge--default|jsdom|jsdom|${assertion}`;
...
describe("Badge contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="badge" on its root', () => {
