...
/**
 * Contract probe for Image (`packages/ui/src/components/image/image.tsx`), derived from its
 * `Default` story (packages/ui/src/components/image/image.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/image/image.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `display-image--default|jsdom|jsdom|${assertion}`;
