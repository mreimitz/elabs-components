...
/**
 * Contract probe for ParallaxPlane (`packages/ui/src/components/parallax-plane/parallax-plane.tsx`), derived from its
 * `Default` story (packages/ui/src/components/parallax-plane/parallax-plane.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../components/parallax-plane/parallax-plane.stories";
...
describe("ParallaxPlane contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="parallax-plane" on its root', () => {
    const { container } = render(<Component {...args} />);
    expect(container.querySelector('[data-slot="parallax-plane"]')).not.toBeNull();
  });
});
