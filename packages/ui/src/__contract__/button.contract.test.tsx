...
/**
 * Contract probe for Button (`packages/ui/src/components/button/button.tsx`), derived from its
 * `Default` story (packages/ui/src/components/button/button.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `core-button--default|jsdom|jsdom|${assertion}`;
...
describe("Button contract", () => {
  ...
  contractIt("data-slot", 'exposes data-slot="button" on its root', () => {
