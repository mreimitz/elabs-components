 ...
 * trace components (`@qlik-coe-emea/qlabs-components-ai` Tool / ChainOfThought / Confirmation /
 ...
 * with no fuller `Status` semantics (e.g. `@qlik-coe-emea/qlabs-components-flow`'s `FlowNode.tone`,
...
/** The editor/markdown `Timeline` 3-state vocabulary (`@qlik-coe-emea/qlabs-components-editor`). */
 ...
 * `@qlik-coe-emea/qlabs-components-ai` (`statusFromToolState`, tool.tsx) so `@qlik-coe-emea/qlabs-components-ui` stays free of
