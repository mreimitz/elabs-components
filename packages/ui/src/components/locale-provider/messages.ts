...
export const DEFAULT_MESSAGES: Record<string, MessageValue> = {
  ...
  // Column filters (header filter button, floating filter row, filter chips).
  // `{name}` is the column's header label.
  "data.table.filter": "Filter {name}",
  "data.table.filterActive": "Filter {name}, active",
  "data.table.filterMenuItem": "Filter…",
  "data.table.filterOperator": "Condition",
  "data.table.filterValue": "Value",
  "data.table.filterTo": "and",
  "data.table.filterJoin": "Combine conditions",
  "data.table.filterAnd": "AND",
  "data.table.filterOr": "OR",
  "data.table.filterOpContains": "Contains",
  "data.table.filterOpNotContains": "Does not contain",
  "data.table.filterOpEquals": "Equals",
  "data.table.filterOpNotEquals": "Does not equal",
  "data.table.filterOpStartsWith": "Starts with",
  "data.table.filterOpEndsWith": "Ends with",
  "data.table.filterOpBlank": "Is blank",
  "data.table.filterOpNotBlank": "Is not blank",
  "data.table.filterOpGt": "Greater than",
  "data.table.filterOpGte": "Greater than or equal to",
  "data.table.filterOpLt": "Less than",
  "data.table.filterOpLte": "Less than or equal to",
  "data.table.filterOpBetween": "Between",
  "data.table.filterOpOn": "On",
  "data.table.filterOpBefore": "Before",
  "data.table.filterOpAfter": "After",
  "data.table.filterPresetToday": "Today",
  "data.table.filterPresetYesterday": "Yesterday",
  "data.table.filterPresetLast7Days": "Last 7 days",
  "data.table.filterPresetLast30Days": "Last 30 days",
  "data.table.filterPresetLast90Days": "Last 90 days",
  "data.table.filterPresetThisWeek": "This week",
  "data.table.filterPresetLastWeek": "Last week",
  "data.table.filterPresetThisMonth": "This month",
  "data.table.filterPresetLastMonth": "Last month",
  "data.table.filterPresetThisQuarter": "This quarter",
  "data.table.filterPresetLastQuarter": "Last quarter",
  "data.table.filterPresetThisYear": "This year",
  "data.table.filterPresetLastYear": "Last year",
  "data.table.filterPresetYearToDate": "Year to date",
  "data.table.filterPickDate": "Pick a date",
  "data.table.filterSearchValues": "Search values…",
  "data.table.filterSelectAll": "Select all",
  "data.table.filterBlanks": "(Blanks)",
  "data.table.filterNoValues": "No matching values",
  "data.table.filterMoreValues": "{count} more — refine the search",
  "data.table.filterTrue": "Yes",
  "data.table.filterFalse": "No",
  "data.table.filterAny": "All",
  "data.table.filterClear": "Clear filter",
  // A chip: "{name}: {summary}". A condition summary is "{op} {value}".
  "data.table.filterChip": "{name}: {summary}",
  "data.table.filterSummary": "{op} {value}",
  "data.table.filterSetMore": "{first} +{count}",
  // Find in table (Ctrl/⌘+F inside a DataGrid).
  "data.table.find": "Find in table",
  "data.table.findPlaceholder": "Find…",
  "data.table.findCount": "{current} of {total}",
  "data.table.findNone": "No matches",
  ...
  "charts.selection.axisX": "X axis",
  "charts.selection.axisY": "Y axis",
  "charts.selection.rangeX": "Select a range on the X axis",
  "charts.selection.rangeY": "Select a range on the Y axis",
  "charts.selection.rangeGroupX": "Range on the X axis, {axis}",
  "charts.selection.rangeGroupY": "Range on the Y axis, {axis}",
  "charts.selection.rangeStart": "Range start, {axis}",
  ...
  "charts.selection.keyboardRectHint":
    "Press S for a crosshair and move it with the arrow keys. Hold Space and use the arrow keys to draw a rectangle; release Space to select. Hold Shift to add, Ctrl to toggle. Escape cancels.",
  "charts.selection.announce.rectMode":
    "Rectangle selection. Hold Space and use the arrow keys to draw.",
  "charts.selection.announce.cancelled": "Selection cancelled",
  "charts.selection.announce.none": "No points selected",
  "charts.selection.announce.points": {
    one: "{count} point selected",
    other: "{count} points selected",
  },
  "charts.selection.announce.range": {
  ...
  // the sentences the figure description adds per analytic.
  "charts.analytics.mean": "Average",
  "charts.analytics.median": "Median",
  "charts.analytics.min": "Minimum",
  "charts.analytics.max": "Maximum",
  "charts.analytics.sum": "Total",
  "charts.analytics.constant": "Reference",
  "charts.analytics.custom": "Computed value",
  "charts.analytics.percentile": "Percentile {p}",
  "charts.analytics.percentileRange": "Percentiles {from}–{to}",
  "charts.analytics.iqr": "Interquartile range",
  "charts.analytics.stddev": "{center} {k} SD",
  "charts.analytics.stddevBand": "{center} ± {k} SD",
  "charts.analytics.ci": "{level} % confidence interval",
  "charts.analytics.trend": "Trend",
  "charts.analytics.trendLog": "Logarithmic trend",
  "charts.analytics.trendExp": "Exponential trend",
  "charts.analytics.trendPow": "Power trend",
  "charts.analytics.trendPoly": "Polynomial trend (degree {degree})",
  "charts.analytics.trendLoess": "Smoothed trend",
  "charts.analytics.rSquared": "r² {value}",
  "charts.analytics.windowMean": "{k}-point moving average",
  "charts.analytics.windowMedian": "{k}-point moving median",
  "charts.analytics.windowSum": "{k}-point moving total",
  "charts.analytics.windowMin": "{k}-point moving minimum",
  "charts.analytics.windowMax": "{k}-point moving maximum",
  "charts.analytics.windowEwm": "{k}-point exponential average",
  "charts.analytics.forecast": "Forecast",
  "charts.analytics.forecastLegend": "{name} ({level} interval)",
  "charts.analytics.errorBars": "Error range",
  "charts.analytics.rises": "rises",
  "charts.analytics.falls": "falls",
  "charts.analytics.flat": "stays flat",
  "charts.analytics.describeTrend": "{name} {direction}, {fit}",
  "charts.analytics.describeTrendNoFit": "{name} {direction}",
  "charts.analytics.describeWindow": "A {name} of {series}",
  "charts.analytics.describeForecast":
    "A {horizon}-step forecast of {series} with a {level} interval, ending at {value} ({low}–{high})",
  "charts.analytics.describeErrorBars": "Error bars on {series}",
  ...
  // dashboard pack rebuild: locked tiles, the empty sheet, the edit-mode tile chrome.
  "charts.dashboard.edit.locked": "{title} is locked",
  "charts.dashboard.edit.lock": "Lock position and size",
  "charts.dashboard.edit.unlock": "Unlock",
  "charts.dashboard.edit.emptyTitle": "This sheet is empty",
  "charts.dashboard.edit.emptyDescription":
    "Drag a tile from the asset panel onto the sheet, or press Add in the toolbar.",
  "charts.dashboard.edit.emptyViewTitle": "Nothing to show yet",
  "charts.dashboard.edit.emptyViewDescription": "Switch to Edit to add the first tile.",
  "charts.dashboard.edit.tileDuplicate": "Duplicate {title}",
  "charts.dashboard.edit.tileDelete": "Delete {title}",
  "charts.dashboard.edit.tileProperties": "Properties of {title}",
  "charts.dashboard.edit.tileMore": "More actions for {title}",
  "charts.dashboard.toolbar.assets": "Assets",
  "charts.dashboard.toolbar.properties": "Properties",
  "charts.dashboard.toolbar.layout": "Layout",
  "charts.dashboard.toolbar.showGrid": "Show grid",
  "charts.dashboard.toolbar.tidyUp": "Tidy up",
  "charts.dashboard.toolbar.tidyUpDescription": "Reflow every tile into a clean reading order",
  "charts.dashboard.toolbar.selectAll": "Select all",
  "charts.dashboard.toolbar.deleteSelection": "Delete selection",
  "charts.dashboard.toolbar.duplicateSelection": "Duplicate selection",
  "charts.dashboard.toolbar.editSheet": "Edit sheet",
  "charts.dashboard.toolbar.done": "Done",
  "charts.dashboard.toolbar.more": "More",
  "charts.dashboard.toolbar.saved": "All changes saved",
  "charts.dashboard.toolbar.layoutFor": "Layout for",
  "charts.dashboard.toolbar.layoutBase": "Desktop",
  "charts.dashboard.toolbar.layoutMd": "Tablet",
  "charts.dashboard.toolbar.layoutSm": "Phone",
  "charts.dashboard.toolbar.gridDensityNow": "{columns} × {rows} cells",
  "charts.dashboard.toolbar.gridDensityFlow": "{columns} columns · {rowHeight} px rows",
  "charts.dashboard.properties.layout": "Layout",
  "charts.dashboard.properties.column": "Column",
  "charts.dashboard.properties.row": "Row",
  "charts.dashboard.properties.width": "Width",
  "charts.dashboard.properties.height": "Height",
  "charts.dashboard.properties.lockedDescription":
    "A locked tile keeps its cells when others move.",
  "charts.dashboard.properties.noRoom": "No room for that size here",
  ...
  // charts — RM-187: words the chart families used to hard-code in English —
  // tooltip rows, accessible summaries, empty states, control labels, the
  // ChartFrame summary and footer. Reuse before minting: zoom controls read
  // `charts.zoom.*`, the distribution median reads `charts.analytics.median`.
  "charts.chart.emptyTitle": "No data",
  "charts.chart.emptyMessage": "No data to plot.",
  "charts.tooltip.value": "Value",
  "charts.canvasLayer.label": "Chart marks",
  "charts.gauge.defaultLabel": "Total",
  "charts.treeChart.path": "Path",
  "charts.treeChart.members": "Members",
  "charts.treeChart.hiddenLeaves": "Hidden leaves",
  "charts.treemap.share": "Share",
  "charts.treemap.folded": "Folded",
  "charts.treemap.zoomInto": "Zoom into {name}",
  "charts.network.summary": "Network, {parts}",
  "charts.network.nodes": { one: "{count} node", other: "{count} nodes" },
  "charts.network.links": { one: "{count} link", other: "{count} links" },
  "charts.network.groups": { one: "{count} group", other: "{count} groups" },
  "charts.heatmap.grid": "{rows} rows × {columns} columns",
  ...
  "charts.sankey.threads": "Threads",
  "charts.sankey.nodeValue": "{value} sessions",
  "charts.distribution.iqr": "IQR",
  "charts.distribution.range": "Range",
  "charts.distribution.records": "Records",
  "charts.distribution.density": "Density",
  "charts.bump.period": "Period",
  "charts.bump.rank": "Rank",
  "charts.waterfall.before": "Before",
  "charts.waterfall.after": "After",
  ...
  "charts.chartFrame.summaryAvg": "avg",
  "charts.chartFrame.footerChart": "Chart",
  "charts.chartFrame.footerMap": "Map",
  "charts.chartFrame.footerTable": "Table",
  "charts.chartFrame.footerSource": "Source",
