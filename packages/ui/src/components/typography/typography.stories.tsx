    ...
    docs: {
      description: {
        component:
          ...
          "`@qlik-coe-emea/qlabs-components-tokens/styles.css` sets `-webkit-font-smoothing: antialiased` and " +
...
export const TextVariants: Story = {
  render: () => (
    <div className="max-w-2xl space-y-3">
      ...
      <Text variant="code">pnpm --filter @qlik-coe-emea/qlabs-components-ui test</Text>
    </div>
  ),
};
