/**
 * Prose primitives — reading-surface typography, promoted from @qlik-coe-emea/qlabs-components-editor
 * (#188; ADR-0012 own/re-export model: @qlik-coe-emea/qlabs-components-ui owns the canonical source,
 * `@qlik-coe-emea/qlabs-components-editor/markdown` re-exports them under their original names —
 ...
 * WYSIWYG editor derives its CSS vars from (@qlik-coe-emea/qlabs-components-editor `markdown-scale`).
