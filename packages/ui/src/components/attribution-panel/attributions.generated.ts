...
export const ATTRIBUTIONS: readonly Attribution[] = [
  ...
  {
    version: null,
    note: "Vendored into @elabs/components-ai and rewired onto brand-ui primitives and tokens. Apache-2.0, NOT MIT: §4 obliges us to carry the notice and to state that we modified the files.",
  ...
  },
  {
    ...
    usedBy: ["@elabs/components-charts"],
    required: false,
  },
  {
    version: null,
    ...
    usedBy: ["@elabs/components-viewer"],
    required: false,
  },
  {
    version: null,
  ...
  {
    version: null,
    note: "The MapLibre component set @elabs/components-maps was adapted from (ADR 0015).",
    id: "mapcn",
    category: "source",
    name: "mapcn",
    license: "MIT",
  ...
  },
  {
    ...
    usedBy: ["@elabs/components-editor"],
    required: false,
  },
  {
    version: null,
  ...
  },
  {
    ...
    usedBy: ["@elabs/components-ai", "@elabs/components-editor"],
    required: false,
    note: null,
  },
  {
  ...
  },
  {
    ...
    usedBy: ["@elabs/components-ai", "@elabs/components-charts"],
    required: false,
    note: null,
  },
  {
  ...
  },
  {
    ...
    usedBy: ["@elabs/components-ai", "@elabs/components-ui"],
    required: false,
    note: null,
  },
] as const;
