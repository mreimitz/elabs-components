...
```bash
pnpm add @qlik-coe-emea/qlabs-components-marketing
```
...
@source "../node_modules/@qlik-coe-emea/qlabs-components-marketing/dist";
```
...
6 exported components — including `CTASection`, `FeatureGrid`, `Hero`, `LogoStrip`, `StatsBand`.
