...
/**
 * Contract probe for ThemeFamilySwitch (`packages/marketing/src/theme-family-switch/theme-family-switch.tsx`), derived from its
 * `Default` story (packages/marketing/src/theme-family-switch/theme-family-switch.stories.tsx). See scripts/gen-contract-tests.mjs.
 */
import { describe, it, expect, afterEach } from "vitest";
import { render, cleanup } from "@testing-library/react";
import { createRef } from "react";
import * as stories from "../theme-family-switch/theme-family-switch.stories";
...
function contractIt(assertion: string, name: string, fn: () => void) {
  const key = `marketing-themefamilyswitch--default|jsdom|jsdom|${assertion}`;
