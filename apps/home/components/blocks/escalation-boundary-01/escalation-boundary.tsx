// registry: escalation-boundary-01 — copied 2026-09-19
"use client";
...
import { formatCount, formatShare } from "../agent-ops-parts/format";
import { EvidenceMeter } from "../agent-ops-parts/provenance";
