// registry: agent-studio-page — copied 2026-09-23
/**
...
import { AgentDesigner } from "../agent-designer-01/agent-designer";
import { MCP_SERVERS, SKILLS } from "../agent-designer-01/data/catalog";
import { SCENARIOS } from "../agent-designer-01/data/scenarios";
import type { DesignerScenario, McpServerData, SkillData } from "../agent-designer-01/types";
