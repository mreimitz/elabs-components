...
export default function StartPage() {
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-16 px-6 pt-16 pb-24">
      <SiteGround />
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-3">
              <CommandLine label={copy.connect.pluginAdd} command={install.plugin.marketplaceAdd} />
