...
export const templatePitch: Record<string, string> = {
  ...
  // Website pages
  landing: "The front door of a SaaS product.",
  "product-landing": "A product-led landing page with the product in the hero.",
  developers: "A developer-facing landing page: install, code, integrate.",
  pricing: "A pricing page with plans, a comparison table and an FAQ.",
  features: "A long-form features page.",
  integrations: "An integrations directory page.",
  compare: "A versus / alternative-to page.",
  about: "A company about page.",
  careers: "A careers page with open roles.",
  contact: "A contact page.",
  blog: "A blog index page.",
  "blog-article": "A single blog post.",
  changelog: "A product changelog page.",
  "help-center": "A help center / support landing page.",
  "case-studies": "A customers / case-studies index page.",
  "customer-story": "A single customer story.",
  resources: "A resources library page.",
  "coming-soon": "A pre-launch / waitlist page.",
  "sign-in": "The sign-in route of a product website.",
  "sign-up": "The sign-up route of a product website.",
  "forgot-password": "The password-reset route.",
  shop: "A storefront listing page.",
  product: "A product detail page of a store.",
  checkout: "The checkout route of a store.",
  account: "A signed-in account page of a store or community.",
  "not-found": "The 404 route of a website.",
  "talk-to-sales": "A talk-to-sales page with a bookable walkthrough.",
};
