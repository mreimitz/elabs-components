...
**Radius:** `calc(var(--radius-base) * (1 - var(--decoration-factor)))` · **Tokens:** 255
...
| `@elabs-ai/components-process` | packages/process | 36 | 4 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
