...
**Radius:** `calc(var(--radius-base) * (1 - var(--decoration-factor)))` · **Tokens:** 231
...
| `@elabs-ai/components-process` | packages/process | 10 | 2 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
