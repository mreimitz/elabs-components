...
| `@elabs-ai/components-process` | packages/process | 25 | 4 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
