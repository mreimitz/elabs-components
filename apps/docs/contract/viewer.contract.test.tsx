...
/**
 * Browser contract probes (axe + horizontal-overflow) for every viewer
...
// ── FileViewer (packages/viewer/src/file-viewer/file-viewer.tsx) ────────────────────────────────────────
import * as stories_file_viewer from "../../../packages/viewer/src/file-viewer/file-viewer.stories";
describe("FileViewer contract (browser)", () => {
  const meta = stories_file_viewer.default as {
    component?: unknown;
    args?: Record<string, unknown>;
  };
  const Default = (stories_file_viewer as { Default?: { args?: Record<string, unknown> } }).Default;
