...
test("the @elabs-ai/components-ai a11y-critical surfaces are already routed through t()", async () => {
  // ADR 0017 Stage 1: every aria-label and placeholder in @elabs-ai/components-ai is
