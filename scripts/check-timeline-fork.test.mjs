...
// (absolute w-px connector + status-keyed style map) flags; (4) a @qlik-coe-emea/qlabs-components-ui
...
test("imports, re-exports, and type-only declarations do NOT flag", () => {
  const cases = [
    'import { Timeline, TimelineItem } from "@qlik-coe-emea/qlabs-components-ui";',
    'export { Timeline, type TimelineProps } from "@qlik-coe-emea/qlabs-components-ui";',
    'export { Timeline, type TimelineEntry as TimelineItem } from "@qlik-coe-emea/qlabs-components-ui";',
...
test("a @qlik-coe-emea/qlabs-components-ui rail consumer with extra absolute w-px decoration does NOT flag", () => {
  const consumer = `import { TimelineRoot, TimelineItem } from "@qlik-coe-emea/qlabs-components-ui";\n${HAND_ROLLED_RAIL}`;
