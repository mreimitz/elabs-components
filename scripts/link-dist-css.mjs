 ...
 * silently unstyled, which is exactly how `@qlik-coe-emea/qlabs-components-maps` lost its popup overrides
 * and `@qlik-coe-emea/qlabs-components-editor` lost the whole markdown-editor stylesheet.
 *
 * Packages like `@qlik-coe-emea/qlabs-components-maps` document "consumers add no CSS imports", so the
