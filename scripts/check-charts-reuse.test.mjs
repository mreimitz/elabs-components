...
test("DOES NOT FLAG: import { Card, Table, TooltipContent } from @qlik-coe-emea/qlabs-components-ui", () => {
  assert.ok(
    isClean(`import { Card, Table, TooltipContent } from "@qlik-coe-emea/qlabs-components-ui";`),
  );
});

test("DOES NOT FLAG: export { Card } from @qlik-coe-emea/qlabs-components-ui (pass-through re-export)", () => {
  assert.ok(isClean(`export { Card } from "@qlik-coe-emea/qlabs-components-ui";`));
});
...
test("DOES NOT FLAG: comments mentioning old names", () => {
  ...
  assert.ok(isClean(`/* import { Card } from "@qlik-coe-emea/qlabs-components-ui" */`));
});
...
test("does not flag unrelated modules or lookalikes", () => {
  ...
  assert.ok(isClean(`import { cn } from "@qlik-coe-emea/qlabs-components-ui";`));
