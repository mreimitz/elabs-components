 ...
 *
 * Enforces ADR-0008 + docs/DECISIONS.md §D6: `@elabs-ai/components-ai` may import the Vercel AI
 ...
 * `@elabs-ai/components-ai` pulls a runtime value from `ai`, brand-ui stops being a presentation
...
function main(argv) {
  ...
  if (findings.length) {
    ...
    console.error(
      `\n@elabs-ai/components-ai must import \`ai\`/\`@ai-sdk/*\` as TYPES ONLY (use \`import type\`). Runtime\n` +
