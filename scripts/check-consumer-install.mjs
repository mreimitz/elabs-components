 ...
 * every gate resolves `@qlik-coe-emea/qlabs-components-*` to TypeScript SOURCE through the `exports` map
 ...
 *      point each @qlik-coe-emea/qlabs-components-* dependency at its tarball.
 ...
 * covers packages that expose a consumer IMPORT surface. `@qlik-coe-emea/qlabs-components-cli`
...
/** `@qlik-coe-emea/qlabs-components-ui` @ 1.9.0 → `brand-ui-1.9.0.tgz` (pnpm's pack naming). */
...
export function pinToTarballs(pkgJson, packed) {
  ...
  for (const key of Object.keys(deps)) {
    ...
    else if (key.startsWith("@qlik-coe-emea/qlabs-components-")) missing.push(key);
  }
...
export function checkUseClient(modules, violations) {
  const mustHave = [
    "@qlik-coe-emea/qlabs-components-tokens/dist/index.js",
    "@qlik-coe-emea/qlabs-components-ui/dist/index.js",
    "@qlik-coe-emea/qlabs-components-data/dist/index.js",
    "@qlik-coe-emea/qlabs-components-ai/dist/index.js",
    "@qlik-coe-emea/qlabs-components-flow/dist/index.js",
    "@qlik-coe-emea/qlabs-components-maps/dist/index.js",
    "@qlik-coe-emea/qlabs-components-charts/dist/index.js",
    "@qlik-coe-emea/qlabs-components-editor/dist/index.js",
    "@qlik-coe-emea/qlabs-components-viewer/dist/index.js",
  ];
  const mustNotHave = [
    "@qlik-coe-emea/qlabs-components-ui/dist/lib/cn.js",
    "@qlik-coe-emea/qlabs-components-editor/dist/markdown/parse.js",
    "@qlik-coe-emea/qlabs-components-editor/dist/markdown/frontmatter.js",
    "@qlik-coe-emea/qlabs-components-icons/dist/index.js",
    "@qlik-coe-emea/qlabs-components-marketing/dist/index.js",
  ];
...
export function checkFontAssets(modules, violations) {
  const css = join(modules, "@qlik-coe-emea/qlabs-components-tokens/dist/themes.css");
  ...
  for (const m of text.matchAll(/url\(\s*(?:"([^"]*)"|'([^']*)')\s*\)/g)) {
    ...
    if (!existsSync(resolve(base, ref))) {
      violations.push({
        ...
        detail: `@qlik-coe-emea/qlabs-components-tokens themes.css references ${ref}, which is not in the tarball — text silently falls back`,
      });
    }
  }
}
 ...
 * is exactly what @qlik-coe-emea/qlabs-components-flow's ^12.11.1 vs @qlik-coe-emea/qlabs-components-ai's ^12.3.6 could produce.
 *
