...
**If you find yourself reaching for `@elabs-ai/components-marketing` (Hero, StatsBand, FeatureGrid,
...
These are the only places `@elabs-ai/components-marketing` belongs inside a pro app.
