...
rulebook (Ant Design + Clarity) and mapped to `@elabs-ai/components-*`. Apply these when building
...
| Area                            | Do                                                                                                          | Build with (`@elabs-ai/components-*`)                                                 |
| ------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
...
| **Data display** (R065–R072)    | order by importance; design extreme states; tables vs cards; "-" for empty; collapse                        | `DataTable` (`@elabs-ai/components-data`), `Card`, `Badge`, `Table`                   |
...
| **AI/productivity** (R100–R103) | source+confidence+reversibility; review states; editable-in-context; recoverable AI errors                  | `@elabs-ai/components-ai` (`Reasoning`, `Tool`, `Sources`), `ContextPanel`            |
...
note some clusters live in `@elabs-ai/components-charts`/`ai`/`marketing`/`flow`/`editor`; reach for one only
