...
export function AppShell({
  ...
  return (
    <SidebarProvider>
      ...
      {/* Right-side detail panel: generic → a right <Sheet/> or <Drawer/> (@qlik-coe-emea/qlabs-components-ui,
          side="right") or an inspector <aside>. For an AI workspace use the ContextPanel
          family from @qlik-coe-emea/qlabs-components-ai (ContextPanelProvider + <ContextPanel/>). */}
    </SidebarProvider>
  );
}
