...
**Exported surface:** 1296 components · 94 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        219 |    40 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
