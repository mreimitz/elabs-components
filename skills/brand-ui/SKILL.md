...
**Exported surface:** 1125 components · 79 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        146 |    32 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
