...
**Exported surface:** 1279 components · 93 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        206 |    39 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
