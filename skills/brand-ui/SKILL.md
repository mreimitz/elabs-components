...
**Themes (2):** dark, light (default) · **Tokens:** 312 · **Registry blocks:** 186 · **Components:** 473 in 13 packages
...
- `@elabs-ai/components-flow` (23): Branded React Flow canvas, nodes, edges, controls, inspector.
