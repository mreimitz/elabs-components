...
**Themes (2):** dark, light (default) · **Radius:** `calc(var(--radius-base) * (1 - var(--decoration-factor)))` · **Tokens:** 253 · **Registry blocks:** 26

**Exported surface:** 1206 components · 86 hooks across 13 packages.
...
| `@elabs-ai/components-process`   |         28 |     4 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
