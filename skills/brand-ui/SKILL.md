...
**Exported surface:** 1197 components · 85 hooks across 13 packages.
...
| `@elabs-ai/components-process`   |         21 |     4 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
