...
**Themes (2):** dark, light (default) · **Tokens:** 285 · **Registry blocks:** 162 · **Components:** 452 in 13 packages
...
- `@elabs-ai/components-charts` (97): MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).
