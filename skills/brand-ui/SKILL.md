...
**Exported surface:** 1189 components · 85 hooks across 13 packages.
...
| `@elabs-ai/components-ui`        |        384 |    15 | Foundation + app UI (Button, Card, Dialog, Tabs, AppShell, …).                                                |
...
| `@elabs-ai/components-charts`    |        188 |    35 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
...
| `@elabs-ai/components-process`   |         11 |     3 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
