...
**Exported surface:** 1219 components · 87 hooks across 13 packages.
...
| `@elabs-ai/components-process`   |         41 |     5 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
