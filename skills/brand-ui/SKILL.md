...
**Exported surface:** 1279 components · 92 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        206 |    38 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
