...
**Exported surface:** 1162 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        183 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
