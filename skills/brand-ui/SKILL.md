...
**Exported surface:** 1142 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        163 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
