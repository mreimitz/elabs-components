...
**Exported surface:** 1141 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        162 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
