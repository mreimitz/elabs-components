...
**Exported surface:** 1122 components · 79 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        143 |    32 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
