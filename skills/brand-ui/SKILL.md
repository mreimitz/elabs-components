...
**Exported surface:** 1299 components · 96 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        222 |    42 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
