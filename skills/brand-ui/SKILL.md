...
**Exported surface:** 1143 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        164 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
