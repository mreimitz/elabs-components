...
**Themes (2):** dark, light (default) · **Radius:** `calc(var(--radius-base) * (1 - var(--decoration-factor)))` · **Tokens:** 255 · **Registry blocks:** 27

**Exported surface:** 1242 components · 89 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        192 |    36 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
...
| `@elabs-ai/components-process`   |         62 |     7 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
