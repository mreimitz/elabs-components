...
**Exported surface:** 1292 components · 94 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        215 |    40 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
