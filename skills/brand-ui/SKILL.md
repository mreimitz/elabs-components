...
**Themes (2):** dark, light (default) · **Radius:** `calc(var(--radius-base) * (1 - var(--decoration-factor)))` · **Tokens:** 255 · **Registry blocks:** 33

**Exported surface:** 1235 components · 87 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        193 |    36 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
