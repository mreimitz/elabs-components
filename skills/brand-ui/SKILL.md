...
**Exported surface:** 1127 components · 79 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        148 |    32 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
