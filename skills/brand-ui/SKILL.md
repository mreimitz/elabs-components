...
**Exported surface:** 1295 components · 96 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        218 |    42 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
