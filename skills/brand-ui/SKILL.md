...
**Exported surface:** 1144 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        165 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
