...
**Exported surface:** 1125 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        146 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
