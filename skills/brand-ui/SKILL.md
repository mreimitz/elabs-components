...
**Exported surface:** 1146 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        167 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
