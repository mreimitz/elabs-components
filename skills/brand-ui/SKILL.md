...
**Exported surface:** 1126 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        147 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
