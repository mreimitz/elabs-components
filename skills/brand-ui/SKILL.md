...
**Exported surface:** 1278 components · 90 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        201 |    36 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
