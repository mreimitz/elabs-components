...
**Exported surface:** 1147 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        168 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
