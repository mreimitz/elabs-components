...
**Exported surface:** 1284 components · 94 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        211 |    40 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
