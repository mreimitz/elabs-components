...
**Exported surface:** 1205 components · 86 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        191 |    36 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
