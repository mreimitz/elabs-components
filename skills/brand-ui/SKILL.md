...
**Exported surface:** 1158 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        179 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
