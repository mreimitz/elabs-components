...
**Exported surface:** 1286 components · 94 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        213 |    40 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
