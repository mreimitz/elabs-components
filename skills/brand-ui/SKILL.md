...
**Themes (2):** dark, light (default) · **Radius:** `calc(var(--radius-base) * (1 - var(--decoration-factor)))` · **Tokens:** 255 · **Registry blocks:** 65

**Exported surface:** 1277 components · 92 hooks across 13 packages.
...
| `@elabs-ai/components-ui`        |        392 |    15 | Foundation + app UI (Button, Card, Dialog, Tabs, AppShell, …).                                                |
...
| `@elabs-ai/components-charts`    |        204 |    38 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
| `@elabs-ai/components-marketing` |          7 |     0 | Hero, FeatureGrid, UseCaseCard, StatsBand, CTASection, LogoStrip.                                             |
