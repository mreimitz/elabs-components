...
**Exported surface:** 1294 components · 96 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        217 |    42 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
