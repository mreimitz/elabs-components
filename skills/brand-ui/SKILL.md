...
**Exported surface:** 1210 components · 86 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        196 |    36 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
