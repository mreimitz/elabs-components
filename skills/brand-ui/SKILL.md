...
**Themes (2):** dark, light (default) · **Radius:** `calc(var(--radius-base) * (1 - var(--decoration-factor)))` · **Tokens:** 252 · **Registry blocks:** 26

**Exported surface:** 1194 components · 85 hooks across 13 packages.
...
| `@elabs-ai/components-process`   |         18 |     4 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
