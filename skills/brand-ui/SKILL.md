...
**Exported surface:** 1152 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        173 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
