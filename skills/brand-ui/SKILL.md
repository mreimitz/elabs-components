...
**Exported surface:** 1282 components · 94 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        209 |    40 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
