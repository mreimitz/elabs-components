...
**Exported surface:** 1209 components · 86 hooks across 13 packages.
...
| `@elabs-ai/components-process`   |         31 |     4 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
