...
**Themes (2):** dark, light (default) · **Tokens:** 312 · **Registry blocks:** 176 · **Components:** 468 in 13 packages
...
- `@elabs-ai/components-data` (15): TanStack DataTable, FilterBar, SearchInput, FacetFilter, ColumnPicker.
...
- `@elabs-ai/components-maps` (18): MapLibre GL maps: MapCanvas, markers, popups, controls, routes, arcs, GeoJSON, clusters.
- `@elabs-ai/components-charts` (105): MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).
