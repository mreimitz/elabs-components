...
**Exported surface:** 1293 components · 94 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        216 |    40 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
