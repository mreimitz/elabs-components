...
**Exported surface:** 1237 components · 89 hooks across 13 packages.
...
| `@elabs-ai/components-process`   |         57 |     7 | Process mining and event-log analysis: process map, variants, cases, conformance — composes flow/charts/data. |
