...
**Exported surface:** 1283 components · 93 hooks across 13 packages.
...
| `@elabs-ai/components-charts`    |        210 |    39 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                                         |
