...
**Themes (2):** dark, light (default) · **Tokens:** 255 · **Registry blocks:** 65 · **Components:** 431 in 13 packages
...
- `@elabs-ai/components-charts` (94): MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).
