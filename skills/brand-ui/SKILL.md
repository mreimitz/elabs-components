...
**Exported surface:** 1120 components · 79 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        141 |    32 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
