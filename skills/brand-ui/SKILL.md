...
**Themes (2):** dark, light (default) · **Radius:** `calc(var(--radius-base) * (1 - var(--decoration-factor)))` · **Tokens:** 228 · **Registry blocks:** 26

**Exported surface:** 1159 components · 81 hooks across 12 packages.
...
| `@elabs-ai/components-charts`    |        180 |    34 | MetricCard, MetricGrid, ChartCard, ChartFrame (expand/flip/download).                    |
