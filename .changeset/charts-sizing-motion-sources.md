...
Charts measure their size, pace their redraws during a resize and decide on reduced motion the same way everywhere. With no new props set, every chart draws at the same size as before.
